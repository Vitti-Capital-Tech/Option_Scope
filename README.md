...
- **Dynamic Portfolio Rotation**: Surgical 1-for-1 replacement using **Conflict-Aware Scanning**. Includes **Leg Swap Optimization** which substitutes only the Long leg when Short strikes match, using weighted average pricing to maintain cost-basis accuracy.
